...
var (
	...
	imageResolutionPaths    = []string{
		...
		"generationConfig.image_size",
		"generationConfig.resolution",
		"generationConfig.outputResolution",
		"generationConfig.output_resolution",
		"generationConfig.imageConfig.imageSize",
		"generationConfig.imageConfig.image_size",
		"generationConfig.imageConfig.resolution",
		"generationConfig.imageConfig.outputResolution",
		"generationConfig.imageConfig.output_resolution",
		"generationConfig.imageConfig.size",
		...
		"generation_config.image_config.outputResolution",
		"generation_config.image_config.output_resolution",
		"generation_config.image_config.size",
		"generation_config.imageSize",
		"generation_config.image_size",
		"generation_config.resolution",
		"generation_config.outputResolution",
		"generation_config.output_resolution",
		...
		"image_config.outputResolution",
		"image_config.output_resolution",
		"image_config.size",
		"responseFormat.image.imageSize",
		"responseFormat.image.image_size",
		"responseFormat.image.resolution",
		"responseFormat.image.outputResolution",
		"responseFormat.image.output_resolution",
		"responseFormat.image.size",
		"response_format.image.imageSize",
		"response_format.image.image_size",
		"response_format.image.resolution",
		"response_format.image.outputResolution",
		"response_format.image.output_resolution",
		"response_format.image.size",
		"generationConfig.responseFormat.image.imageSize",
		"generationConfig.responseFormat.image.image_size",
		"generationConfig.responseFormat.image.resolution",
		"generationConfig.responseFormat.image.outputResolution",
		"generationConfig.responseFormat.image.output_resolution",
		"generationConfig.responseFormat.image.size",
		"generation_config.response_format.image.imageSize",
		"generation_config.response_format.image.image_size",
		"generation_config.response_format.image.resolution",
		"generation_config.response_format.image.outputResolution",
		"generation_config.response_format.image.output_resolution",
		"generation_config.response_format.image.size",
		"input.size",
		"input.imageSize",
		"input.image_size",
		"input.resolution",
		...
		"extra_body.generationConfig.imageConfig.outputResolution",
		"extra_body.generationConfig.imageConfig.output_resolution",
		"extra_body.generationConfig.imageConfig.size",
		"extra_body.generation_config.image_config.outputResolution",
		"extra_body.generation_config.image_config.output_resolution",
		"extra_body.generation_config.image_config.size",
	}

...
func TestRecalculateTaskQuotaByTokensUsesBillingContextGroupRatio(t *testing.T) {
	...
	// ModelRatio already expresses quota units per token. Settlement must use
	// the frozen 0.25 group ratio, not the current 3 or 4 group settings.
	const expectedQuota = 500

...
func GenerateTextOtherInfo(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, modelRatio, groupRatio, completionRatio float64,
	...
	if discount, ok := relayInfo.PriceData.OtherRatios()["scheduled_discount"]; ok {
		other.SetPublic("scheduled_discount", discount)
	}
	if relayInfo.PriceData.ImageResolutionTier != "" {
		other.SetPublic("billing_mode", "image_resolution")
		other.SetPublic("image_resolution", relayInfo.PriceData.ImageResolutionTier)
	}

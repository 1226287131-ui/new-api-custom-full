...
| `USER_SESSION_ACTIVE_LIMIT` | Maximum active login Sessions per user; `0` disables the limit | `9999` |
| `USER_SESSION_ISSUANCE_LIMIT` | Maximum Sessions created per user within the issuance window, including revoked Sessions; `0` disables the limit | `100` |

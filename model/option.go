...
func InitOptionMap() {
	...
	common.OptionMap["ErrorSanitizationKeywords"] = setting.ErrorSanitizationKeywordsToString()
...
func validateOptionValue(key string, value string) error {
	...
	if key == "billing_setting."+billing_setting.ScheduledDiscountField {
		return billing_setting.ValidateScheduledDiscountJSONString(value)
	}
	return nil
}
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "ErrorSanitizationKeywords":

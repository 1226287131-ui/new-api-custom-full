...
export const STATIC_I18N_KEYS = [
  ...
  'Shown',
  'Not shown',
  'Image resolution pricing must be converted manually while preserving every resolution tier and image count.',
  'Task resolution pricing must be converted manually using the task usage schema.',
] as const

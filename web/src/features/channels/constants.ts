...
export const CHANNEL_TYPE_NEW_API_VIDEO = 59
export const CHANNEL_TYPE_OPENAI_VIDEO = 60
export const CHANNEL_TYPE_SUB2API = 61
export const CHANNEL_TYPE_NEW_API = 62
export const CHANNEL_TYPE_MINIMAX_VIDEO = 64
...
> = {
  ...
  59: { descriptionKey: 'NewAPI Video' },
  60: { descriptionKey: 'Openai Video' },
  63: { descriptionKey: 'Grok Video' },
  64: { descriptionKey: 'MiniMax Video' },
...
const CHANNEL_TYPE_DISPLAY_ORDER: number[] = [
  1, 14, 24, 33, 43, 3, 41, 17, 45, 25, 26, 23, 48, 62, 58, 61, 65, 42, 34, 20,
  4, 66, 67, 40, 27, 15, 46, 18, 31, 35, 49, 19, 47, 37, 38, 39, 11, 8, 57, 22,
  21, 44, 2, 5, 36, 50, 51, 52, 53, 54, 55, 56, 59, 60, 63, 64,
]

...
export function ChannelMutateDrawer({
      ...
      {currentType === CHANNEL_TYPE_MINIMAX_VIDEO && (
        <FormField
          ...
          render={({ field }) => (
            <FormItem className='flex items-center justify-between px-4 py-3'>
              <div className='space-y-0.5'>
                <FormLabel>{t('MiniMax Video Prompt Enhancement')}</FormLabel>
                <FormDescription>
                  {t(
  ...
  const customEgressFields = (
    <fieldset disabled={sensitiveLocked}>
      <FormField
        control={form.control}
        ...
        render={({ field }) => (
          <FormItem className='flex items-center justify-between px-4 py-3'>
            <div className='space-y-0.5'>
              <FormLabel>{t('Use dedicated video download proxy')}</FormLabel>
              <FormDescription>
                {t(
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem className='flex items-center justify-between px-4 py-3'>
            <div className='space-y-0.5'>
              <FormLabel>{t('Use dedicated upstream egress proxy')}</FormLabel>
              <FormDescription>
                {t(

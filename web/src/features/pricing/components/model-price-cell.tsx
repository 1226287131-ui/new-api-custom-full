...
import {
  formatPrice,
  formatRequestPrice,
  hasResolutionOrDurationPrice,
} from '../lib/price'
import { useScheduledDiscountClock } from '../lib/scheduled-discount'
...
export function ModelPriceCell(props: {
  ...
  const discountTime = useScheduledDiscountClock()
  ...
  if (!dynamic && hasResolutionOrDurationPrice(props.model)) {
    return <ResolutionPriceCell model={props.model} options={options} />
  }
